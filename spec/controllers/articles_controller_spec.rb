  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved article as @article" do
        ...
        post :create, {:article => { "author" => "invalid value" }}, valid_session
        assigns(:article).should be_a_new(Article)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested article" do
        ...
        Article.any_instance.should_receive(:update).with({ "author" => "MyString" })
        put :update, {:id => article.to_param, :article => { "author" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the article as @article" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Article.any_instance.stub(:save).and_return(false)
        put :update, {:id => article.to_param, :article => { "author" => "invalid value" }}, valid_session
        assigns(:article).should eq(article)
      end
